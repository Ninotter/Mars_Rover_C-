...
namespace RoverTest
{
    public class RoverTest
    {
        ...
        {
            Rover rover = RoverBuilder.CreateBuilder().AddState(10, 5, OrientationsEnum.NORD).Build();
        ...
        {
            Rover rover = RoverBuilder.CreateBuilder().AddState(10, 5, OrientationsEnum.SUD).Build();
            rover.RotateToLeftSide();
            rover.RotateToLeftSide();
            rover.Avancer();
            rover.Avancer();
        ...
        {
            Rover rover = RoverBuilder.CreateBuilder().AddState(5, 10, OrientationsEnum.NORD).AddTorroidalPlanet(10).Build();
            rover.Avancer();
        ...
        {
            Rover rover = RoverBuilder.CreateBuilder().AddState(10, 5, OrientationsEnum.EST).AddTorroidalPlanet(10).Build();
            rover.Avancer();
            rover.Avancer();
